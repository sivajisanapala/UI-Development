...
export const routingcomponents = [LeftComponent, NavComponent, RightComponent, DashboardComponent, RegisterComponent, BboaComponent, FormsComponent, RoutingComponent, CbcComponent, ApiComponent, TypescriptComponent, JscriptComponent, Html5Component, Css3Component, BootstrapComponent, AjaxComponent, NpmComponent]
